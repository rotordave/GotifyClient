...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserWithPass :  IEquatable<UserWithPass>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserWithPass" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserWithPass() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserWithPass" /> class.
        /// </summary>
        ...
        public UserWithPass(bool? admin = default(bool?), string name = default(string), string pass = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for UserWithPass and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (pass == null)
            {
                throw new InvalidDataException("pass is a required property for UserWithPass and cannot be null");
            }
            else
            {
                this.Pass = pass;
        ...
        {
            return this.Equals(input as UserWithPass);
        }

        /// <summary>
        /// Returns true if UserWithPass instances are equal
        /// </summary>
        /// <param name="input">Instance of UserWithPass to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserWithPass input)
        {
            if (input == null)
                return false;
